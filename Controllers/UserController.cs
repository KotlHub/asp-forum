...
namespace ASP_201.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(IHashService hashService, ILogger<UserController> logger, DataContext dataContext, IRandomService randomService, IKdfService kdfService, IValidateService validationService, IEmailService emailService)
        {
        ...
        public String AuthUser()
        {
            ...
            if (user is not null)
            {
                ...
                if (user.PasswordHash ==
                    _kdfService.GetDerivedKey(password, user.PasswirdSalt))
                {
